...
const socialLinks = [
  {
    path:'https://www.facebook.com/med.morsou/',
    icon: <FaFacebook className='group-hover:display-white w-4 h-5'/>
  },
  {
    path:'https://github.com/MohamedMorsou',
    icon: <AiFillGithub className='group-hover:display-white w-4 h-5'/>
  },
  {
    path:'https://www.youtube.com/channel/UC9puMGFGmEOpurhu4cq4HpA',
    icon: <AiFillYoutube className='group-hover:display-white w-4 h-5'/>
  },
  {
    path:'https://www.linkedin.com/in/mohamed-morsou-70b579195/',
    icon: <RiLinkedinFill className='group-hover:display-white w-4 h-5'/>
  },
  {
    path:'https://www.instagram.com/developer_digital?igsh=MTM0dG5maW9yaGIwMA==',
    icon: <AiOutlineInstagram className='group-hover:display-white w-4 h-5'/>
  },
]
